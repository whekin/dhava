...
- Use the dirt-red brand palette and `DhavaTheme`. Keep dynamic color off unless the product decision changes. Design dark mode first, then verify light mode.
