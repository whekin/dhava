...
data class DhavaLocationFix(val lat: Double, val lon: Double)
 ...
 */
suspend fun currentLocationFix(context: Context): DhavaLocationFix? {
    ...
    return try {
        ...
        val fix = fresh
            ...
            ?: cached
        fix?.let { DhavaLocationFix(it.latitude, it.longitude) }
