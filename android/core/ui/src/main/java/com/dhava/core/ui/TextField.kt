 ...
 * that reads as a web form control. A Dhava field is one quiet filled surface
            ...
            decorationBox = { field ->
                Row(
                    modifier = Modifier
                        ...
                        .defaultMinSize(minHeight = DhavaSizes.compactControl)
                        .padding(horizontal = DhavaSpacing.large, vertical = DhavaSpacing.medium),
