...
import com.dhava.core.map.SegmentLibraryCameraAction
import com.dhava.core.map.SegmentLibraryCameraRequest
import com.dhava.core.map.SegmentLibraryLine
...
private fun LibrarySheetHeader(
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            if (selected == null) {
                DhavaSectionLabel("Local segments")
